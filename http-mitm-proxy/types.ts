...
import type { Agent as HttpsAgent, Server } from "https";
...
export type IContext = ICallbacks &
  IBaseContext & {
    ...
    proxyToServerRequest: ClientRequest | undefined;
    serverToProxyResponse: IncomingMessage | undefined;
...
export type IWebSocketContext = IBaseContext & {
  ...
  clientToProxyWebSocket?: WebSocketType | undefined;
  /** instance of WebSocket object from https://github.com/websockets/ws */
  proxyToServerWebSocket?: WebSocketType | undefined;
